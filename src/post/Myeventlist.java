...
public class Myeventlist extends HttpServlet {
	public void doGet(HttpServletRequest request,
			...
			String docType =
				...
				out.println(docType +
						...
						out.println("<li><a class='sel' href='post.Myeventlist'>My Events</a></li>");
			...
			try {
				...
				while (rs.next()) {
					...
					if(emailmember.equals(author)){
						out.print("<TR><TD> "+ time+"\n"+"<TD> "+ eventDate+"\n"+"<TD><form method='post' action='./post.Myeventprofile'>\n");
